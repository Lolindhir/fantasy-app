...
export class DraftsComponent {
  ...
  private createViewModel(league: League, drafts: RawDraft[], teams: FantasyTeam[]): DraftsViewModel {
    ...
    const futureDrafts = draftViewModels.filter(draft => draft.draft.Season !== league.Season);
