...
class SourceRefreshFreshnessWorkflowTests(unittest.TestCase):
        ...
        workflows = {
            ...
            ".github/workflows/update-fantasy-football-calculator-adp.yml": (
                ...
                (
                    ...
                    "fantasy-management/_ai/scripts/fantasy_football_calculator_quality.py",
                    "fantasy-management/_ai/scripts/fantasy_football_calculator_kicker_adp.py",
                    "fantasy-management/sources/external-rankings/adp/fantasy-football-calculator/quality-policy.json",
                    ...
                    "fantasy-management/_ai/scripts/tests/test_fantasy_football_calculator_quality.py",
                    "tools/nfl_season_context.py",
                    "tools/tests/test_nfl_season_context.py",
                    ".github/workflows/update-fantasy-football-calculator-adp.yml",
                ),
            ),
            ".github/workflows/update-fftoday-projections.yml": (
    ...
    def test_materializer_consumes_heartbeat_directory_and_publishes_gate(self) -> None:
        ...
        for required in (
            ...
            "fantasy-management/automation/season-aware-operations-policy.json",
