...
def build_audit(
    ...
    return {
        ...
        "rules": {
            ...
            "verifiedProviderAlias": "Provider aliases require exact matching birth date plus provider-specific corroboration: ESPN at least one, PFR at least two other strong identity IDs.",
